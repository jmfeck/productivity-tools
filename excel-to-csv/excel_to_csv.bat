:: Batch script: mass_excel_to_csv.bat
@echo off
...
:: Separator and decimal symbol (adjust as needed)
set "separator=,"  
set "decimal=."
...
for %%f in (%input_folder%\*.xlsx) do (
    ...
    :: Run the Python script to convert the file without showing Excel
    python excel_to_csv.py "!input_file!" "!output_file!" "%separator%" "%decimal%"
